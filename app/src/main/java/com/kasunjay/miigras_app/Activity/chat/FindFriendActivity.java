...
import com.kasunjay.miigras_app.databinding.ActivityFindFriendBinding;
...
public class FindFriendActivity extends AppCompatActivity implements UserListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chat.setOnClickListener(v -> {
            startActivity(new android.content.Intent(FindFriendActivity.this, InboxActivity.class));
            finish();
        });
